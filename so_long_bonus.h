...
/*   Updated: 2025/02/18 16:06:21 by hwahmane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						error_exit(char *message, char *line, int fd,
							char **array);
int						check_t_b_wall(char *line);
int						check_caracters(char *line, t_mlx_data *data, int i);
void					*check_element_map(char *line, t_mlx_data *data, int fd,
							int len);
...
void					stop_animation(t_mlx_data *data, int num, int link,
							int alive);
...
// bonus_commands3
void					player_side(t_mlx_data *data, int front, int right,
							int move);
